...
using System.IO;
using Plugins;
using script.core.db.migration;
using UnityEngine;
...
namespace script.core.db
{
    ...
    public class DbManager
    {
		...
		// データベースファイル名
		private static readonly string DB_NAME = "heroMaster.db";
		...
		private void CreateDbTables() {
			saveTable = new SAVETable(ref mdb);
		}
	
		private void MargeData(ref SqliteDatabase oldDb) {
			saveTable.MargeData(ref oldDb);
		}
	
		public SAVETable GetSAVETable() {
			return saveTable;
		}
